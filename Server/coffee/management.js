...
(function() {
  var gitPullClicked, gitPushClicked, initEnvironmentDropdown, initFileInputs, initGitButtons, initProductButtons, initSearchBoxes, initTestButtons, onInputFileChanged, productPullListClicked, productPushFileClicked, productRemoveFileClicked, productRestartClicked, switchEnvironmentProduct, switchEnvironmentTest, testCompileFileClicked, testResetEnvironmentClicked, testTestFileClicked;
  ...
  switchEnvironmentTest = function() {
    ...
    return $('#panel-product-board').hide();
  };
