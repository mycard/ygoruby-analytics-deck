...
(function() {
  ...
  this.classificationSetHTML = function(classification) {
    ...
    if (type === 'deck') {
      ...
      setSetTypeName();
      return setCardsSetHTML(classification);
    }
  };
  ...
  classificationRestrainSetHTML = function(restrains) {
    ...
    for (_i = 0, _len = restrains.length; _i < _len; _i++) {
      ...
      if (restrain instanceof Array) {
        restrain_gotten_html = this.restrainGroupHTML(restrain);
      } else {
  ...
  setCardsSetHTML = function(set_json) {
    var set_gotten_html;
    if (!set_json) {
      return;
    }
    ...
    return $("ul#preview-restrains").append(set_gotten_html[1]);
  };
  ...
  decktypeSetTypeName = function() {
    ...
    return $("div#lbl-restrain").html("约束");
  };
  ...
  setSetTypeName = function() {
    $("div#type-name").html("字段");
    return $("div#lbl-restrain").html("集合");
  };
